...
$TYPO3_CONF_VARS['BE']['AJAX']['tx_gclib_TCAform_autocomplete::saveNewAutoCompleteItem'] = t3lib_extMgm::extPath($_EXTKEY).'lib/class.tx_gclib_TCAform_autocomplete.php:tx_gclib_TCAform_autocomplete->saveNewAutoCompleteItem';
?>
